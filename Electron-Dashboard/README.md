...
1. Run `python3 -m http.server 8085` in the `/home/GUI` directory.
2. Visit [http://localhost:8085/Landing-Page/index.html](http://localhost:8085/Landing-Page/index.html).
